...
public interface CameraErrorView {
	public static final String MISSING_ERROR = "ShootOFF can no longer communicate with "
			+ "the webcam unplugged?";
	public static final String FPS_WARNING = "The FPS from %s has dropped to %f, "
			+ "which is too low for reliable shot detection. Some shots may be missed. "
			+ "You may be able to raise the FPS by closing other applications.";
	public static final String BRIGHTNESS_WARNING = "The camera %s is streaming frames "
			+ "that are very bright. This will increase the odds of shots falsely being detected. "
